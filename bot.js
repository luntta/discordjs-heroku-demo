// Lataa .env-tiedosto, jos ei olla tuotantoympäristössä
	...
	if (cmd === "ping") {
		...
		if (!match) {
			message.channel.send(
				"I'm not reaaallly sure what you're trying to do. Maybe try 2d8+4 instead? :)"
			);
		}
...
function stop(message, serverQueue) {
	...
	return message.channel.send(
		"Okay, okay, I'm stopping the music! The party is over."
	);
}
